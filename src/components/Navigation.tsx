    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
      <div className="container mx-auto px-6 py-3 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3">
          <img src={logo} alt={PRACTICE.displayName} className="h-10 w-auto" />
        ...
        <div className="hidden md:flex items-center space-x-4">
          <a href={CONTACT.phoneHref} className="text-minimal text-primary font-semibold hover:text-primary/80 transition-colors">
            {CONTACT.phone}
          </a>
          <ThemeToggle />
        </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-background border-b border-border">
          <div className="container mx-auto px-6 py-6 space-y-4">
            ...
            <a href={CONTACT.phoneHref} className="block text-minimal text-primary font-semibold">
              {CONTACT.phone}
            </a>
